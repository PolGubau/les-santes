...
describe("time helpers", () => {
	...
	describe("enumerateDayKeys", () => {
		it("returns an inclusive contiguous range", () => {
			expect(enumerateDayKeys("2026-07-27", "2026-07-30")).toEqual([
				"2026-07-27",
				"2026-07-28",
				"2026-07-29",
				"2026-07-30",
		...
		it("returns a single key when start equals end", () => {
			expect(enumerateDayKeys("2026-07-27", "2026-07-27")).toEqual([
				"2026-07-27",
			]);
		});

		it("crosses month boundaries", () => {
			expect(enumerateDayKeys("2026-07-30", "2026-08-01")).toEqual([
				"2026-07-30",
				"2026-07-31",
				"2026-08-01",
			]);
		...
		it("returns empty when start is after end", () => {
			expect(enumerateDayKeys("2026-07-30", "2026-07-27")).toEqual([]);
		});
	});
