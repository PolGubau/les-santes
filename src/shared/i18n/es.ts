...
export const es: Translations = {
  ...
  calendar: {
    ...
    addedTitle: '¡Añadido! 📅',
    addedBody: '"%{title}" se ha añadido a tu calendario. Puede tardar unos segundos en aparecer.',
  ...
  settings: {
    ...
    engagementFrequencyDesc: 'Cada cuánto quieres recibir curiosidades y consejos sobre Les Santes.',
  ...
  engagement: {
    ...
    body6: 'Recuerda añadir tus actos favoritos para recibir avisos 30 minutos antes.',
    body7: 'Mataró ya empieza a oler a pólvora y fiesta. ¿Estás listo?',
    body8: '¿Has visto las postales de Gigantes invitados? ¡Hay de toda Cataluña!',
    body9: 'El Bequetero es el himno no oficial de Les Santes. ¡1, 2, 15!',
    body10: '¿Buscas un acto familiar? Utiliza los filtros para encontrarlos rápidamente.',
    body11: 'Descubre la historia de nuestras comparsas en la guía cultural.',
    body12: '¿Ya has elegido dónde ver los fuegos artificiales de este año? El Callao nunca falla.',
    body13: '¡Faltan pocos días! Revisa que tengas toda la ropa blanca lista para la Crida.',
  },
};
