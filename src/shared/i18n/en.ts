...
export const en: Translations = {
	...
	calendar: {
		...
		addedTitle: "Added! 📅",
		addedBody:
			'"%{title}" has been added to your calendar. It may take a few seconds to appear.',
	...
	agenda: {
		...
		emptyFavoritesCtaDesc:
			"You don't have any favourites yet. Browse the events and save the ones you like.",
		...
		emptyFilteredNudgeDesc:
			"Want to see what is happening right now at the festival?",
	...
	now: {
		...
		suggestAgendaDesc:
			"Browse the schedule and save the events you don't want to miss.",
	...
	map: {
		...
		locationAlertBody:
			"Allow access to your location to see yourself on the map and find nearby events.",
	...
	event: {
		...
		suggestMapDesc:
			"Open the map to see where this event is and how to get there.",
		suggestMapCta: "View on map",
		suggestFavoriteTitle: "Save your favourites",
		suggestFavoriteDesc:
			"Add events to favourites so you can find them quickly and get reminders.",
	...
	dailyAgenda: {
		title: "📅 Tomorrow at Les Santes",
		body: "See everything happening tomorrow at the festival. Tap to open the agenda.",
	},
	quickActions: {
		upNext: "Up next",
	...
	onboarding: {
		...
		welcomeDesc:
			"The festival\u2019s official schedule. See what is on now, what is next and save your favourite events.",
		welcomeCta: "Let\u2019s start",
		locationTitle: "Location (optional)",
		locationDesc:
			"Lets you see nearby events and sort them by distance. You can turn it off any time.",
		locationCta: "Enable location",
		notNow: "Not now",
		notificationsTitle: "Reminders (optional)",
		notificationsDesc:
			"We\u2019ll remind you 30 minutes before any event you favourite. No spam.",
	...
	error: {
		...
		screenDescription:
			"An unexpected error occurred. Go back home and try again.",
	},
	...
	settings: {
		...
		clearCacheConfirm:
			"This will delete locally saved data. The app will re-download it.",
		...
		rateAppHint: "Give us stars in the store",
		...
		engagementFrequencyDesc:
			"How often you want to receive tips and trivia about Les Santes.",
		engagementEveryTwoDays: "Every 2 days",
		engagementNever: "Never",
	},
	feedback: {
		...
		messageDisclaimer:
			"Please do not include personal data (name, phone, email). Your message is sent anonymously.",
		tag: {
			map: "Map",
			events: "Events",
			agenda: "Schedule",
	...
	privacy: {
		...
		privacyText:
			"Les Santes does not require registration nor collect personal data. We only send anonymous usage events (non-identifying) and, if you choose to, the feedback you submit. You can opt out of analytics in Settings.",
		sectionData: "Data we use",
		locationLabel: "Location",
		locationDesc:
			'Optional. Only used for the "Near me" filter on the map. Never sent to any server.',
		notificationsLabel: "Notifications",
		notificationsDesc:
			"Optional. Processed locally on your device to remind you of upcoming events. We do not register your token on our server.",
		cacheLabel: "Local cache",
		cacheDesc:
			"Programme data stored on your device so the app works offline. Cleared via Settings.",
		analyticsLabel: "Anonymous analytics",
		analyticsDesc:
			"Usage events (screen views, actions) tagged with a random install ID. No personal information. You can disable it in Settings.",
		feedbackLabel: "Feedback (optional)",
		feedbackDesc:
			"If you send feedback, we store the rating, message and technical context (version, platform). We never ask for or store your identity.",
	...
	engagement: {
		...
		body0:
			"Did you know Robafaves and the Giantess got married in 1850? Discover more in Resources!",
		body1:
			"Do you like fireworks? Check the best spots on the map for the big night.",
		body2:
			"La Juliana is made of gin, rum, vodka and orange soda. Careful, it kicks hard!",
		body3:
			'The "No n’hi ha prou" is the wildest act. Do you already have your festival scarf?',
		body4: 'Kids have their own "No n’hi ha prou" for children. Don’t miss it!',
		body5:
			"Check out the posters from 100 years ago in the Resources section. They are art!",
		body6:
			"Remember to add your favorite events to receive reminders 30 minutes before.",
		body7:
			"Mataró is starting to smell like gunpowder and celebration. Are you ready?",
		body8:
			"Have you seen the Guest Giants postcards? There are some from all over Catalonia!",
		...
		body11:
			"Discover the history of our traditional groups in the cultural guide.",
		body12:
			"Have you chosen where to watch this year’s fireworks? El Callao never fails.",
		body13:
			"Few days left! Make sure you have your white clothes ready for the Crida.",
	},
};
