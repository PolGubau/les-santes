...
export interface Translations {
	...
	filters: {
		...
		espectacle: string;
		jocs: string;
		categoryNocturn: string;
		categoryFamiliar: string;
		categoryTradicional: string;
	...
	now: {
		...
		subtitle: string;
		emptyNow: string;
		emptyNowSubtext: string;
		goToSchedule: string;
		festivalEnded: string;
		festivalEndedSubtext: string;
		liveCount: string;
...
export const ca: Translations = {
	...
	calendar: {
		...
		addedTitle: "Afegit! 📅",
		addedBody:
			'"%{title}" s\'ha afegit al teu calendari. Pot trigar uns segons a aparèixer.',
	...
	agenda: {
		...
		emptyFavoritesCtaDesc:
			"Encara no tens cap favorit. Mira els actes i guarda els que t'interessin.",
		...
		emptyFilteredNudgeDesc:
			"Vols veure què està passant ara mateix al festival?",
	...
	now: {
		...
		suggestAgendaDesc:
			"Explora l'agenda i guarda els actes que no et vols perdre.",
	...
	event: {
		...
		suggestFavoriteDesc:
			"Afegeix actes a favorits per veure'ls ràpid i rebre recordatoris.",
	...
	onboarding: {
		...
		notificationsDesc:
			"T’avisem 30 minuts abans dels actes que afegeixis a favorits. Sense spam.",
	...
	settings: {
		...
		clearCacheConfirm:
			"Esborraràs les dades guardades localment. L'app les tornarà a descarregar.",
		...
		rateAppHint: "Posa’ns estrelles a la botiga",
	...
	feedback: {
		...
		messageDisclaimer:
			"No incloguis dades personals (nom, telèfon, email). El comentari s’envia de forma anònima.",
		tag: {
			map: "Mapa",
			events: "Actes",
			agenda: "Agenda",
	...
	privacy: {
		...
		privacyText:
			"Les Santes no demana registre ni recull dades personals. Només s'envien esdeveniments d'ús anònims (no identificables) i, si tu ho fas, el feedback que ens enviïs. Pots desactivar les estadístiques als Ajustos.",
		sectionData: "Dades que utilitzem",
		locationLabel: "Ubicació",
		locationDesc:
			'Opcional. Només per al filtre "Prop meu" al mapa. Mai s\'envia a cap servidor.',
		notificationsLabel: "Notificacions",
		notificationsDesc:
			"Opcional. Es processen localment al dispositiu per recordar-te actes pròxims. No registrem el token al servidor.",
		cacheLabel: "Caché local",
		cacheDesc:
			"Dades del programa guardades al dispositiu per funcionar sense connexió. Es poden esborrar des d'Ajustos.",
		analyticsLabel: "Estadístiques anònimes",
		analyticsDesc:
			"Esdeveniments d'ús (pantalles vistes, accions) amb un identificador d'instal·lació aleatori. Sense informació personal. Pots desactivar-les als Ajustos.",
		feedbackLabel: "Feedback (opcional)",
		feedbackDesc:
			"Si ens envies un comentari, guardem la valoració, el text i el context tècnic (versió, plataforma). No demanem ni guardem identitat.",
	...
	engagement: {
		...
		body0:
			"Sabies que en Robafaves i la Geganta es van casar el 1850? Descobreix més a Recursos!",
		body1:
			"T’agraden els focs? Revisa els millors llocs al mapa per la Nit de Sant Joan.",
		body2:
			"La Juliana és la beguda secreta de Les Santes, gaudeix‑la si tens edat per fer-ho!",
		body3:
			'El "No n’hi ha prou" és l’acte més canalla. Ja tens el mocador de la festa?',
		body4:
			'Els nens i nenes tenen el seu propi "No n’hi ha prou" infantil. No te’l perdis!',
		body5:
			"Fes una ullada als cartells de fa 100 anys a la secció de Recursos. Són art!",
		body6:
			"Recorda afegir els teus actes preferits per rebre avisos 30 minuts abans.",
		body7: "Mataró ja comença a fer olor a pólvora i festa. Estàs a punt?",
		body8:
			"Has vist les postals de Gegants convidats? N’hi ha de tot Catalunya!",
		body9: "El Bequetero és l’himne no oficial de Les Santes. 1, 2, 15!",
		body10:
			"Busques un acte familiar? Utilitza els filtres per trobar‑los ràpidament.",
		body11:
			"Descobreix la història de les nostres comparses a la guia cultural.",
		body12:
			"Ja has triat on veure els focs artificials d’aquest any? El Callao mai falla.",
		body13:
			"Falten pocs dies! Revisa que tinguis tota la roba blanca a punt per la Crida.",
	},
};
